...
export default function Tip({ children, align = 'center', width = 'w-60' }) {
    ...
    return (
        <span
            role="tooltip"
            className={`pointer-events-none absolute bottom-full z-30 mb-2 ${width} ${position} rounded-xl bg-gray-900 px-3 py-2.5 text-left text-[11.5px] font-normal leading-relaxed text-white opacity-0 shadow-lg transition-opacity duration-150 group-hover:opacity-100 group-focus-within:opacity-100`}
        >
            {children}
        </span>
    );
