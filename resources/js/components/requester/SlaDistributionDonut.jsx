 ...
 */
const SEGMENTS = [
    { key: 'onTrack', label: 'On Track', color: 'var(--chart-green)', helpKey: 'requester.sla_help.ontrack' },
    { key: 'warning', label: 'SLA Warning', color: 'var(--chart-amber)', helpKey: 'requester.sla_help.warning' },
    { key: 'breach', label: 'SLA Breach', color: 'var(--chart-red)', helpKey: 'requester.sla_help.breach' },
];
