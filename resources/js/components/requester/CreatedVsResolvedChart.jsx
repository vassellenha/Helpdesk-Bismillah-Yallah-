    ...
    return (
        <div className="flex h-full flex-col gap-4">
            <div className="flex items-start justify-between">
                <div>
                    <h2 className="text-[15px] font-bold text-gray-900 dark:text-ink-1">Tickets Created vs Resolved</h2>
                ...
                <div className="flex gap-3.5 text-[11px] font-medium text-gray-400 dark:text-ink-3">
                    <span className="flex items-center gap-1.5"><span className="h-2.5 w-2.5 rounded-[3px] bg-blue-600 dark:bg-blue-500" />Created</span>
