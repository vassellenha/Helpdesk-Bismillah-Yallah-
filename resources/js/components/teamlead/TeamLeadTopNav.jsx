            ...
            <div className="relative">
                ...
                >
                    ...
                    <span className="hidden text-left leading-tight sm:block">
                        <span className="block text-[13px] font-semibold text-gray-900 dark:text-ink-1">{user.name ?? 'Team Lead'}</span>
                    ...
                    <div className="absolute right-0 top-[54px] z-50 w-[250px] overflow-hidden rounded-2xl border border-gray-200 dark:border-edge-strong bg-white dark:bg-panel-2 p-1.5 shadow-xl">
                        <div className="mb-1.5 flex items-center gap-2.5 border-b border-gray-50 px-3 py-2.5">
                            ...
                            <span className="min-w-0">
                                <span className="block truncate text-[13px] font-bold text-gray-900 dark:text-ink-1">{user.name ?? 'Team Lead'}</span>
                        ...
                        <a href={dashboardUrl} className="flex items-center gap-2.5 rounded-[9px] px-3 py-2.5 text-[13px] font-medium text-gray-700 dark:text-ink-2 hover:bg-gray-50 dark:hover:bg-panel-hover dark:even:bg-white/[0.03] hover:text-gray-900 dark:hover:text-ink-1">
                            Dashboard
                        </a>
