...
export default function TeamLeadWorkspace(props) {
    ...
    return (
        <div className="flex min-h-screen flex-col">
            ...
            {toast && (
                <div className="fixed bottom-6 left-1/2 z-[80] -translate-x-1/2 rounded-xl bg-gray-900 dark:bg-panel-selected px-4 py-2.5 text-[13px] font-semibold text-white shadow-lg">
                    {toast}
                </div>
            )}
        </div>
