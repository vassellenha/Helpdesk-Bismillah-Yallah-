...
const RELATIVE_PERIODS = { 'Last 30 Days': 30, 'Last 3 Month': 90, 'Last 6 Month': 183, 'This Year': 366 };
...
export default function SupportHistoryPage({ counts = {}, rows = [] }) {
    ...
    const filtered = useMemo(() => {
        const periodDays = RELATIVE_PERIODS[periodLabel];
        ...
        return list;
    }, [rows, activeStatus, layanan, periodLabel, search, sortKey, sortDir]);
