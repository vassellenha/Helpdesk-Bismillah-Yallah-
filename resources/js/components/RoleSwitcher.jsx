    ...
    return (
        <div ref={ref} className="fixed bottom-6 right-6 z-50">
            ...
            <button
                type="button"
                onClick={() => setOpen((v) => !v)}
                className="flex items-center gap-2 rounded-full bg-blue-700 dark:bg-blue-500 px-4 py-2.5 text-sm font-semibold text-white shadow-lg hover:bg-blue-800 dark:hover:bg-blue-400"
            >
