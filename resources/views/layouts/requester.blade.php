...
<body class="min-h-screen bg-gray-50 dark:bg-panel-0 font-sans text-gray-900 dark:text-ink-1 antialiased">
        ...
        <header class="sticky top-0 z-20 flex h-[62px] items-center gap-6 border-b border-gray-200 dark:border-edge-strong bg-white dark:bg-panel-1 px-7">
            ...
            <nav class="flex items-center gap-1">
                <a
                    ...
                    class="flex items-center gap-2 rounded-[10px] px-3.5 py-2 text-[13px] font-semibold {{ request()->routeIs('dashboard.requester') ? 'bg-blue-50 dark:bg-accent-soft text-blue-700 dark:text-accent-text' : 'text-gray-600 dark:text-ink-2 hover:bg-gray-50 dark:hover:bg-panel-hover hover:text-gray-900 dark:hover:text-ink-1' }}"
                >
                ...
                <a
                    ...
                    class="flex items-center gap-2 rounded-[10px] px-3.5 py-2 text-[13px] font-semibold {{ request()->routeIs('requester.tickets') ? 'bg-blue-50 dark:bg-accent-soft text-blue-700 dark:text-accent-text' : 'text-gray-600 dark:text-ink-2 hover:bg-gray-50 dark:hover:bg-panel-hover hover:text-gray-900 dark:hover:text-ink-1' }}"
                >
    ...
    <div
        ...
        data-props="{{ json_encode(['roles' => $switcherRoles, 'current' => $role ?? 'requester', 'portalUrl' => route('portal.index')]) }}"
    ></div>
</body>
</html>
