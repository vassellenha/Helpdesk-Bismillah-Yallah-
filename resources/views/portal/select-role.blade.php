...
<div class="mx-auto max-w-6xl px-6 py-16">
    ...
    <h1 class="mt-2 text-4xl font-extrabold text-gray-900 dark:text-ink-1">Mockup Review — Pilih Role</h1>
    ...
    <p class="mt-10 text-sm text-gray-400 dark:text-ink-3">Mockup interaktif — bukan aplikasi produksi. Data yang ditampilkan bersifat dummy.</p>
</div>
@endsection
