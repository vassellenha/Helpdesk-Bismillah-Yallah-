...
class UserRoleSeeder extends Seeder
{
    ...
    private const USERS = [
        ...
        ['name' => 'Karina Putri', 'nip' => '19900322014', 'email' => 'karina.putri@adhi.co.id', 'phone' => '+6281298765432', 'address' => 'Jl. Cipinang Cempedak IV No. 12, Jatinegara, Jakarta Timur 13340', 'unit' => 'Dept. Pengendali Operasi', 'jabatan' => 'Manager Dept. Pengendali Operasi', 'kode_departemen' => 'DEPT-PGO', 'kode_divisi' => 'DIV-OPS', 'roles' => ['Approver', 'Team Lead', 'Requester'], 'status' => 'active'],
        ['name' => 'Rizky Hidayat', 'nip' => '19880609027', 'email' => 'rizky.hidayat@adhi.co.id', 'phone' => '+6281322233344', 'address' => 'Jl. Margonda Raya No. 210, Beji, Depok 16424', 'unit' => 'Dept. Supply Chain Management', 'jabatan' => 'Team Lead', 'kode_departemen' => 'DEPT-SCM', 'kode_divisi' => 'DIV-OPS', 'roles' => ['Team Lead', 'Requester'], 'status' => 'active'],
        ['name' => 'Dimas Kurniawan', 'nip' => '10021190', 'email' => 'dimas.kurniawan@adhi.co.id', 'phone' => '+6281811166677', 'address' => 'Jl. Bintaro Utama Sektor 3A No. 8, Pesanggrahan, Jakarta Selatan 12330', 'unit' => 'Dept. Keuangan', 'jabatan' => 'Team Lead', 'kode_departemen' => 'DEPT-KEU', 'kode_divisi' => 'DIV-FIN', 'roles' => ['Team Lead', 'Requester'], 'status' => 'active'],
        ['name' => 'Raka Mahendra', 'nip' => '19891117033', 'email' => 'raka.mahendra@adhi.co.id', 'phone' => '+6281911177788', 'address' => 'Jl. Cikutra Baru Raya No. 27, Cibeunying, Bandung 40124', 'unit' => 'Dept. Infrastruktur I', 'jabatan' => 'Team Lead', 'kode_departemen' => 'DEPT-INF1', 'kode_divisi' => 'DIV-INF', 'roles' => ['Team Lead', 'Requester'], 'status' => 'active'],
        ['name' => 'Fajar Nugraha', 'nip' => '19850228041', 'email' => 'fajar.nugraha@adhi.co.id', 'phone' => '+6281433344455', 'address' => 'Jl. Kelapa Gading Boulevard Blok C No. 5, Kelapa Gading, Jakarta Utara 14240', 'unit' => 'Satuan Pengawas Internal', 'jabatan' => 'Team Lead', 'kode_departemen' => 'DEPT-SPI', 'kode_divisi' => 'DIV-KOR', 'roles' => ['Team Lead', 'Requester'], 'status' => 'active'],
        ['name' => 'Nina Amelia', 'nip' => '19920504052', 'email' => 'nina.amelia@adhi.co.id', 'phone' => '+6281544455566', 'address' => 'Jl. Ciputat Raya No. 91, Pondok Pinang, Jakarta Selatan 12310', 'unit' => 'Adhi Learning Center', 'jabatan' => 'Knowledge Administrator', 'kode_departemen' => 'DEPT-ALC', 'kode_divisi' => 'DIV-SDM', 'roles' => ['Team Lead', 'Knowledge Administrator', 'Requester'], 'status' => 'active'],
