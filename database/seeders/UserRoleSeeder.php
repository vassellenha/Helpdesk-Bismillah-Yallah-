...
class UserRoleSeeder extends Seeder
{
    ...
    private const USERS = [
        ...
        ['name' => 'Arief Kurniawan', 'nip' => '19970312107', 'email' => 'arief.kurniawan@adhi.co.id', 'whatsapp' => '+6282199900011', 'unit' => 'Dept. Strava', 'jabatan' => 'IT Support Staff', 'roles' => ['Support IT', 'Requester'], 'status' => 'active'],
        ['name' => 'Febria Sahrina', 'nip' => '19970825033', 'email' => 'febria.sahrina@adhi.co.id', 'whatsapp' => '+6282199900033', 'unit' => 'Dept. Strava', 'jabatan' => 'IT Support Staff', 'roles' => ['Support IT', 'Requester'], 'status' => 'active'],
        ['name' => 'Agung Wijayanto', 'nip' => '19960904044', 'email' => 'agung.wijayanto@adhi.co.id', 'whatsapp' => '+6282199900044', 'unit' => 'Dept. Strava', 'jabatan' => 'IT Support Staff', 'roles' => ['Support IT', 'Requester'], 'status' => 'active'],
        ['name' => 'Naufal Akbar', 'nip' => '19980117055', 'email' => 'naufal.akbar@adhi.co.id', 'whatsapp' => '+6282199900055', 'unit' => 'Dept. Strava', 'jabatan' => 'IT Support Staff', 'roles' => ['Support IT', 'Requester'], 'status' => 'active'],
        ['name' => 'Sarah', 'nip' => '19970630066', 'email' => 'sarah@adhi.co.id', 'whatsapp' => '+6282199900066', 'unit' => 'Dept. Strava', 'jabatan' => 'IT Support Staff', 'roles' => ['Support IT', 'Requester'], 'status' => 'active'],
        ['name' => 'Kevin', 'nip' => '19981203077', 'email' => 'kevin@adhi.co.id', 'whatsapp' => '+6282199900077', 'unit' => 'Dept. Strava', 'jabatan' => 'IT Support Staff', 'roles' => ['Support IT', 'Requester'], 'status' => 'active'],
        ['name' => 'Rian', 'nip' => '19960516088', 'email' => 'rian@adhi.co.id', 'whatsapp' => '+6282199900088', 'unit' => 'Dept. Strava', 'jabatan' => 'IT Support Staff', 'roles' => ['Support IT', 'Requester'], 'status' => 'active'],
        ...
        ['name' => 'Rio Saputra', 'nip' => '19960421118', 'email' => 'rio.saputra@adhi.co.id', 'whatsapp' => '+6282199900022', 'unit' => 'Dept. Supply Chain Management', 'jabatan' => 'BPO Support Staff', 'roles' => ['Support BPO', 'Requester'], 'status' => 'active'],
        ['name' => 'Genta Pratama', 'nip' => '19970709099', 'email' => 'genta.pratama@adhi.co.id', 'whatsapp' => '+6282199900099', 'unit' => 'Dept. Supply Chain Management', 'jabatan' => 'BPO Support Staff', 'roles' => ['Support BPO', 'Requester'], 'status' => 'active'],
        ['name' => 'Lutfi Ramadhan', 'nip' => '19980222100', 'email' => 'lutfi.ramadhan@adhi.co.id', 'whatsapp' => '+6282199900100', 'unit' => 'Dept. Supply Chain Management', 'jabatan' => 'BPO Support Staff', 'roles' => ['Support BPO', 'Requester'], 'status' => 'active'],
        ['name' => 'Maya Prameswari', 'nip' => '19961114111', 'email' => 'maya.prameswari@adhi.co.id', 'whatsapp' => '+6282199900111', 'unit' => 'Dept. Supply Chain Management', 'jabatan' => 'BPO Support Staff', 'roles' => ['Support BPO', 'Requester'], 'status' => 'active'],
    ];
