...
class SlaPolicySeeder extends Seeder
{
    public function run(): void
    {
        $policies = [
            ...
            ['policy_name' => 'Low Priority', 'priority' => 'Low', 'service_type' => 'Access Request', 'response_time_minutes' => 1440, 'resolution_time_minutes' => 7200, 'warning_threshold_percent' => 70, 'status' => 'inactive'],
        ];
